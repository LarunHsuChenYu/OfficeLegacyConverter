...
internal static class PptxMarkdownPipeline
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            progress.Report((current, total, $"轉換 {resolvedInput} → {rawMdPath}..."));
            MarkItDownConverter.ConvertFile(resolvedInput, rawMdPath, cancellationToken);
